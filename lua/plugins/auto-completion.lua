return {
  {
    ...
    -- Add snippets to auto completion
    dependencies = {
      "rafamadriz/friendly-snippets",
      { -- Include with blink compatibillity plugin
        "saghen/blink.compat",
        version = "*",
    ...
    -- Events that blink.cmp will be emitting
    ...
    opts = {
      ...
      sources = {
        ...
        compat = {}, -- here you can add any nvim-cmp sources we included with blink.compat
      },
