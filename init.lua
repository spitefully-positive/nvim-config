...
https://github.com/numToStr/Comment.nvim to fix commenting

https://github.com/echasnovski/mini.surround to for great "surround-motions"

https://github.com/mg979/vim-visual-multi for multi line editing
Tutorial Link:
